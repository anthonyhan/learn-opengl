...
unsigned int loadTexture2(const char* texPath, GLint format, bool flipY);
...
int main()
{
	...
	unsigned int texture2 = loadTexture2("res/textures/awesomeface.png", GL_RGBA, true);
...
unsigned int loadTexture(const char* texPath, GLint format, bool flipY)
{
	...
	// set when GL_TEXTURE_WRAP == GL_CLAMP_TO_BORDER
