...
FPSCamera camera = FPSCamera(glm::vec3(0.0f, 0.0f, 3.0f));
...
int main()
{
	...
	// -----------------------------------------
	// vertex shader
	Shader shader("7.5.shader.vs", "7.5.shader.fs");
...
void processInput(GLFWwindow* window)
{
	...
	if (glfwGetKey(window, GLFW_KEY_W) == GLFW_PRESS)
		camera.ProcessKeyboard(FPSCamera_Movement::FORWARD, deltaTime);
	if (glfwGetKey(window, GLFW_KEY_S) == GLFW_PRESS)
		camera.ProcessKeyboard(FPSCamera_Movement::BACKWARD, deltaTime);
	if (glfwGetKey(window, GLFW_KEY_A) == GLFW_PRESS)
		camera.ProcessKeyboard(FPSCamera_Movement::LEFT, deltaTime);
	if (glfwGetKey(window, GLFW_KEY_D) == GLFW_PRESS)
		camera.ProcessKeyboard(FPSCamera_Movement::RIGHT, deltaTime);
