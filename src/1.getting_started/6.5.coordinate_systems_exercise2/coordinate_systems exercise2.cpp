...
int main()
{
	...
	// -----------------------------------------
	// vertex shader
	Shader shader("6.5.shader.vs", "6.5.shader.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		view = glm::translate(view, param.offset);
...
void imgui_on_render(ui_params& param)
{
	...
	ImGui::SliderFloat("x", &param.offset.x, -10.0f, 10.0f);
	ImGui::SliderFloat("y", &param.offset.y, -10.0f, 10.0f);
	ImGui::SliderFloat("z", &param.offset.z, -10.0f, 10.0f);
