...
int main()
{
	...
	// -----------------------------------------
	// vertex shader
	Shader lightingShader("4.6.lighting_maps.vs", "4.6.lighting_maps.fs");
	Shader lightCubeShader("4.6.light_cube.vs", "4.6.light_cube.fs");
	...
	unsigned int emissionMap = loadTexture("res/textures/matrix.jpg", GL_RGB, false);
