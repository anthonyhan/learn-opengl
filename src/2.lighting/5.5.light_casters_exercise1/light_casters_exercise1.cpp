...
typedef struct ui_params
{
	...
	float light_spot_cutoff = glm::radians(12.5f);
	float light_spot_outercutoff = glm::radians(17.5f);
...
int main()
{
	...
	// -----------------------------------------
	// vertex shader
	Shader lightingShader("5.5.light_casters.vs", "5.5.light_casters.fs");
	Shader lightCubeShader("5.5.light_cube.vs", "5.5.light_cube.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		*/
		...
		lightingShader.setFloat("light.cutOff", glm::cos(params.light_spot_cutoff));
		lightingShader.setFloat("light.outerCutOff", glm::cos(params.light_spot_outercutoff));
		lightingShader.setBool("enableAttenuation", params.attenuation);
...
void imgui_on_render(ui_params& param)
{
	...
	ImGui::SliderAngle("cutoff", &params.light_spot_cutoff, 0.0f, 90.0f);
	ImGui::SliderAngle("outercutoff", &params.light_spot_outercutoff, 0.0f, 90.0f);
	ImGui::Checkbox("attenuation", &params.attenuation);
