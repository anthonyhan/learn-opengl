...
int main()
{
	...
	unsigned int diffuseMap = loadTexture("res/textures/toy_box_diffuse.png");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        shader.setFloat("heightScale", params.heightScale);
...
void imgui_on_render(ui_params& param)
{
    ...
    ImGui::DragFloat("HeightScale", &params.heightScale, 0.01f, 0.0f, 1.0f);
