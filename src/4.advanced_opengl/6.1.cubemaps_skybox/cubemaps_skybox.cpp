...
int main()
{
    ...
    // -------------------------
    Shader shader("6.1.objects.vs", "6.1.objects.fs");
    ...
    unsigned int cubemapTexture = loadCubeMap(FileSystem::getPath("res/textures/cubemaps/footballfield").c_str(), CUBE_MAP_FACES2);
