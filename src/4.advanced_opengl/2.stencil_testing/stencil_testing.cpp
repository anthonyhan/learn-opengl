...
static const char* DepthFuncNames[] = { "GL_ALWAYS", "GL_NEVER", "GL_LESS", "GL_EQUAL", "GL_LEQUAL", "GL_GREATER", "GL_NOTEQUAL", "GL_GEQUAL" };
static const GLint DepthFuncValues[] = { GL_ALWAYS,GL_NEVER,GL_LESS,GL_EQUAL,GL_LEQUAL,GL_GREATER,GL_NOTEQUAL,GL_GEQUAL };
...
int main()
{
    ...
    // -------------------------
    Shader normalShader("2.stencil_testing.vs", "2.stencil_testing.fs");
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        if (params.outline)
        {
            ...
            // re-enabling depth test and stencil test
            glStencilMask(0xFF);
            glEnable(GL_DEPTH_TEST);
        }
...
void imgui_on_render(ui_params& param)
{
    ...
    ImGui::Checkbox("Outline", &params.outline);
    ImGui::Separator();
